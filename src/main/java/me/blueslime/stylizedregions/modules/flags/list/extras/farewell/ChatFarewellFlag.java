package me.blueslime.stylizedregions.modules.flags.list.extras.farewell;
...
public class ChatFarewellFlag extends Flag {
    public ChatFarewellFlag() {
        super("farewell", "farewell:", "<farewell>");
