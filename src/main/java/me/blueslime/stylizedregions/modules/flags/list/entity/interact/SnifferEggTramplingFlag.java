...
public class SnifferEggTramplingFlag extends Flag {
    public SnifferEggTramplingFlag() {
        super("sniffer-trampling", "sniffer-tramp", "<sniffer-trampling>", "sniffer-egg-trampling", "sniffer-egg-trampling:");
    }
    ...
    public void execute(BukkitMeteorPlugin plugin, String parameter, Region region, Player player) {
        region.setFlag("sniffer-trampling", Boolean.parseBoolean(parameter));
    }
