package me.blueslime.stylizedregions.modules.flags.list.block.leaves;

import me.blueslime.bukkitmeteor.BukkitMeteorPlugin;
import me.blueslime.stylizedregions.modules.flags.flag.Flag;
import me.blueslime.stylizedregions.modules.flags.list.block.leaves.listener.BlockLeavesDecayListener;
import me.blueslime.stylizedregions.modules.region.Region;
import me.blueslime.stylizedregions.utils.region.RegionUtil;
import org.bukkit.entity.Player;

public class BlockLeavesDecayFlag extends Flag {
    public BlockLeavesDecayFlag() {
        super("leaves-decay", "leaves-decay:", "<leaves-decay>");
        registerListeners(new BlockLeavesDecayListener());
    }
    /**
     * Execute action
     *
    ...
    public void execute(BukkitMeteorPlugin plugin, String parameter, Region region, Player player) {
        region.setFlag("leaves-decay", Boolean.parseBoolean(parameter));
    }
