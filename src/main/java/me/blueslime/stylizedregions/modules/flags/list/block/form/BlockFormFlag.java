package me.blueslime.stylizedregions.modules.flags.list.block.form;
...
public class BlockFormFlag extends Flag {
    public BlockFormFlag() {
        super("block-form", "block-form:", "<block-form>","form");
    ...
    public void execute(BukkitMeteorPlugin plugin, String parameter, Region region, Player player) {
        region.setFlag("block-form", Boolean.parseBoolean(parameter));
    }
