package me.blueslime.stylizedregions.modules.flags.list.block.ignite;

import me.blueslime.bukkitmeteor.BukkitMeteorPlugin;
import me.blueslime.stylizedregions.modules.flags.flag.Flag;
import me.blueslime.stylizedregions.modules.flags.list.block.ignite.listener.BlockIgniteListener;
import me.blueslime.stylizedregions.modules.region.Region;
import me.blueslime.stylizedregions.utils.region.RegionUtil;
import org.bukkit.entity.Player;

public class BlockIgniteFlag extends Flag {
    public BlockIgniteFlag() {
        super("block-ignite", "block-ignite:", "<block-ignite>","ignite");
        registerListeners(new BlockIgniteListener());
    }
    /**
     * Execute action
     *
    ...
    public void execute(BukkitMeteorPlugin plugin, String parameter, Region region, Player player) {
        region.setFlag("block-ignite", Boolean.parseBoolean(parameter));
    }
